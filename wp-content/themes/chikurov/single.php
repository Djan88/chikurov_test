      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 order_seminar">
            <?php if (get_field('seminar_online')) { ?>
              <h4 class="content_center" id="order">Что такое Онлайн "Школа Доктора Чикурова"?</h4>
            <?php } else { ?>
              ...
              <?php } else { ?>
                <?php if (get_field('seminar_online')) { ?>
                  <div class="col-md-6 online_school_text">
                    <p>"Онлайн школа" — это возможность освоить "Биологическое центрирование" не отрываясь от работы/учебы, не тратя деньги на билеты и гостинницу, в уютной, домашней атмосфере!</p>
