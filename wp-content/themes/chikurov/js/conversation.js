...
const chat = {
    1: {
        text: 'Приветствуем Вас на сайте "Института Биологического Центрирования!"',
        next: 2
    },
    2: {
    ...
    10: {
        text: 'Мы не продвигаем ни один из объектов размещения. Эти гостиницы наиболее популярны среди наших учеников и расположены на расстоянии до 500 м. от "Института БЦ". Но Вы можете выбрать любой другой вариант.',
        options: [
            {
    ...
    33: {
        text: '"Краниосакральная терапия". Однодневный семинар для практикующих специалистов. Стоимость участия 25 000 руб.',
        options: [
            {
                text: '"Постановка Перцепции"',
                next: 13
    ...
    31: {
        text: 'Слева Вы можете видеть полное расписание семинаров в "Институте Биологического Центрирования"',
        options: [
            {
                text: "Задать другой вопрос",
                next: 3
