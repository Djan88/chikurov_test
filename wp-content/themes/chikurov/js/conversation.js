...
const chat = {
    ...
    2: {
        text: 'Я — элетронный помощник. Могу рассказать с чего начать обучение, подсказать стоимость семинаров или ответить на популярные вопросы.',
        next: 3
    },
    3: {
        text: 'Кликните на одну из тем ниже чтоб узнать подробную информацию. Этот чат можно закрыть в любой момент кликнув на крестик в верхней части окна.',
        options: [
            {
            ...
            {
                text: "Узнать стоимость семинаров",
                next: 6
            },
            {
                text: "Онлайн школа",
