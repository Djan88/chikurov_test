...
const chat = {
    ...
    9: {
        text: 'Вы можете приобрести видозаписи прошедших семинаров. Все семинары были записаны в 2018 году. Читает Ю.В. Чикуров. Стоимость одного видео - 10 тыс руб. Оплатить можно перечислив деньги на предпринимательский счет. В примечании пишете пример:  «За учебный курс БЦ базовый»',
        options: [
            {
