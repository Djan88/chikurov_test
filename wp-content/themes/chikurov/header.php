  ...
  <header class="top-header">
    <div class="container">
      <div class="row contacts_wrap">
        ...
        <div class="col-xs-2 col-sm-1 col-sm-offset-1 col-md-2 header-logo">
          <br>
          <a href="/"><img src="<?php bloginfo('template_url'); ?>/img/logo_chikurov_inst_alt.png" alt="" class="img-responsive logo"></a>
        </div>
      </div>
      <div class="row">
