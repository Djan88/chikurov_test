  ...
  <section class="seminar text-center" id="seminar">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 seminar_type"><i class="fa fa-bookmark" aria-hidden="true"> </i> Обязательный семинар <span class="seminar_timing"><i class="fa fa-clock-o" aria-hidden="true"> </i> 24 учебных часа</span></div>
